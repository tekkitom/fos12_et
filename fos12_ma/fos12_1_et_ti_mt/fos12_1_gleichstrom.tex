...
\end{frame}
  ...
  \begin{frame}{Schaltung 2- nur Quelle 1 aktiv}
    \begin{columns}
      \begin{column}{.6\textwidth}
        \begin{figure}[htb]
          \begin{circuitikz}
    ...
    \end{columns}
  \end{frame}
  \begin{frame}{Schaltung 2- nur Quelle 2 aktiv}
    \begin{columns}
      \begin{column}{.6\textwidth}
        \begin{figure}[htb]
          \begin{circuitikz}
...
Die Bilder für Schaltung 2 und Schaltung 3 sind hier zurzeit überlagert. In der Beamer-Version sind die Bilder gut erkennbar.
  \begin{frame}{Schaltung 3 - nur Quelle 1 aktiv}
    \begin{columns}
      \begin{column}{.6\textwidth}
        \begin{figure}[htb]
          \begin{circuitikz}
  ...
  \begin{frame}{Schaltung 3 - nur Quelle 2 aktiv}
    \begin{columns}
      \begin{column}{.6\textwidth}
        \begin{figure}[htb]
          \begin{circuitikz}
