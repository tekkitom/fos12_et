...
\date{V 0.1.2 - im Aufbau\\ Stand: \today}%\\
...
Die Lösungen sind auf Seite \pageref{lsg:Ersatzwiderstand}
  ...
  \begin{frame}{Nur Quelle U1 aktiv}
    ...
    \end{figure}
    $U_{q1}=5V, U_{Q2}=12V, R1 = 10\Omega ,\ R2 = 20 \Omega ,\ R3 = 30\Omega ,\ R4 = 40 \Omega ,\ R5 = 50 \Omega$
  \end{frame}
...
für die Schaltung in Abbildung \ref{fig:SchaltungZweiQuellenAktiv}.

  \subsection{Schaltung 2}
   \begin{frame}{Schaltung 2}
    \begin{figure}[htb]
      \begin{circuitikz}
        \draw (0,0) to [vsource, l=$U_{q1}$] (0,5);
        \draw (0,5) to [R=$R_1$] (2,5) node[circ]{} node[above]{A} to [R=$R_2$] (2,3) to [short, i>_=$I_2$]  (2,2);
        \draw (2,2) to [R=$R_3$,  v=$U_3$] (2,0) node[circ]{} node[below]{B}  -- (0,0);
        \draw (2,3) -- (3,3) -- (4,3) to[short] (4,3)  to[R=$R_4$]
        (4,0) -- (3,0) -- (2,0);
        \draw (2,5) -- (4,5) to [R=$R_5$] (6,5);
        \draw (6,5) to [R=$R_6$] (6,2);
        \draw (6,2) to [vsource, l=$U_{q2}$] (6,0) -- (6,0);
        \draw (6,0) to [short, -*] (4,0);
      \end{circuitikz}
    ...
    \end{figure}
    $R1 = 100\Omega ,\ R2 = 220 \Omega ,\ R3 = 230\Omega ,\ R4 = 470 \Omega ,\ R5 = 560 \Omega$
  ...
  \subsection{Schaltung 3}
   \begin{frame}{Schaltung 3}
    \begin{figure}[htb]
      \begin{circuitikz}
        \draw (0,0) to [vsource, l=$U_{q1}$] (0,5);
        \draw (0,5) to [R=$R_1$] (2,5) node[circ]{} node[above]{A} to (2,3) node[left]{B} to [short, i>_=$I_3$]  (2,2);
        \draw (2,2)to [R=$R_3$,  v=$U_3$] (2,0) node[circ]{} node[below]{GND}  -- (0,0);
        \draw (4,5) node[circ]{} node[above]{C}  to [R=$R_2$] (4,3);
        \draw (2,3)  (2,3) node[circ]{} -- (4,3) node[circ]{}  node[right]{D} -- (4,2) to[R=$R_4$]
        (4,0) -- (3,0) -- (2,0);
        \draw (2,5) -- (4,5) to [R=$R_5$] (6,5);
        \draw (6,5) to [R=$R_6$] (6,2);
        \draw (6,2) to [vsource, l=$U_{q2}$] (6,0) -- (6,0);
