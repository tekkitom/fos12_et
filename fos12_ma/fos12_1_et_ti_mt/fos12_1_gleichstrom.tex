...
\begin{frame}{Knoten und Maschen}
 \begin{figure}[htbp]
   \only<1>{\includegraphics[height=.9\textheight,keepaspectratio=true]{radar_out_v1_2_markierungenKnoten1.png}
   \caption{Platine Ausgang}
 \label{abb:PlatineOut1}
}
   \only<2>{\includegraphics[height=.9\textheight,keepaspectratio=true]{radar_out_v1_2_markierungenKnoten2.png}
   \caption{Platine Ausgang}
 \label{abb:PlatineOutMarkierung1}
}
   \only<3>{\includegraphics[scale=2,keepaspectratio=true]
     {radar_out_v1_2_markierungenKnoten3.png}
   \caption{Platine Ausgang}
 \label{abb:PlatineOutMarkierung2}
}
  \only<4>{\includegraphics[scale=2,keepaspectratio=true]
     {radar_out_v1_2_markierungenKnoten4.png}
   \caption{Platine Ausgang}
 \label{abb:PlatineOutMarkierung3}
}
  \only<5>{\includegraphics[height=.9\textheight,keepaspectratio=true]{radar_out_v1_2_schaltplan.png}
