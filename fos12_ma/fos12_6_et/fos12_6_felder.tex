...
\begin{frame}{Ladung eines Kondensators I}
  \begin{columns}
    ...
    \begin{tikzpicture}
      ...
      \draw (0,2) to[closing switch, l={t = 0}] (2,2) to [R=$R_1$] (4,2) to[C=$C_1$] (4,0)  -- (0,0);
    \end{tikzpicture}
...
\begin{frame}{Ladung eines Kondensators II}
  \begin{columns}
    ...
    \begin{tikzpicture}
      \draw (0,0) to[vsource, l=$U_{0}$] (0,2);
      \draw (0,2) to[normal closed switch, l={t > 0}] (2,2) to [R=$R_1$] (4,2) to[C=$C_1$] (4,0)  -- (0,0);
    \end{tikzpicture}
    \caption{Reihenschaltung von Widerstand und Kondensator}
...
$u_c (t) = U_0+\Delta U \cdot e^{-\frac{t}{\tau}}$ mit R und C = 1.
\end{frame}
