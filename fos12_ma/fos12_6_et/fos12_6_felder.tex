...
\end{figure}
\column{.7\textwidth}
 Gegeben seien drei Ladungen $Q_1, Q_2\ \text{und} \ Q_3$. Alle Lagungen sind ideal punktförmig und haben den Wert $10\mu C$.
  
  Die Ladungen befinden sich an folgenden Punken: $Q_1= \left(\begin{array}{c} 0 \\ 2 \end{array}\right)$,
...
Berechne das elektrische Feld an folgenden Punkten P

$Q1 = 3\muC\ \left( \begin{Array}{c}0 \\ 0\end{Array} \right)$ $Q2 =-10\muC \ \left( \begin{Array}{c}2m\\n \end{Array} \right )$ Q1(0,0), Q2 (2m, n)
P={(1m,0) (2m, 0) (0.5m, 0.5m) (0.5m, 0) (1m, 2m)} 

Zeichne zusätzlich die Feldlinien quantitativ, Feld von Q1, Feld von Q2 und resultierendes Feld.
...
\appendix
\only<article>{\section{Lösungsvorschläge zu Aufgaben}}
Zu Folie \ref{KraftAufLadungAufgabe1}
