  ...
  \end{figure}
    ...
    \begin{column}{0.5\textwidth}
      \begin{itemize}
        ...
        \item Verbindung mit Spannungsquelle  (t = 0) - Kondensator lädt sich auch - Anzahl der Ladungen verschiebt sich.
...
\begin{tabular}{ll}
 ...
 $t =  \tau$ & $\approx 0,63 \cdot U_0$\\
 $t = 2\tau$ & $\approx 0,86 \cdot U_0$\\
 $t = 3\tau$ & $\approx 0,95 \cdot U_0$\\
 $t = 4\tau$ & $\approx 0,98 \cdot U_0$\\
