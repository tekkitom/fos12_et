...
\begin{document}
  ...
  \begin{frame}{Addition von Vektoren}
    \begin{figure}[htb]
      ...
      $\vec{v}_1= \left(\begin{array}{c} 1 \\ 2 \end{array}\right)$,
  ...
  \begin{frame}{Multiplikation Vektor mit skalarem Wert}
    \begin{figure}[htb]
      \begin{tikzpicture}
        \draw (-2,0) -- (2,0);
        \draw (0,-2) -- (0,2);
        ...
        \draw[->] (0,0) -- (4,2);
        \draw node at (0.9,1.2) {$\vec{v}_1$};
          \draw node at (2.3,1.8) {$\vec{v}_1 * 2$};
      \end{tikzpicture}

      \caption{Zwei Vektor mit skalarer Multiplikation}
      \label{fig:VektorSkalarMultipliziert}
    \end{figure}
  \end{frame}
...
%   }
  ...
  \section[noch offene Themen]{Pflicht-Themen, die noch offen sind}
  \begin{frame}{Pflicht-Themen, die noch offen sind}
    ...
    \begin{itemize}
      ...
      \item Überlagerung von elektrischen Feldern
      \item Kondensator
      \\ Auf- und Entladung
      \item Induktion
