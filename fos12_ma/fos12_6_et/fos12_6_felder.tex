...
Berechnen Sie das resultierende Feld am Schnittpunkt.
  \begin{enumerate}
   \item $\vec{v}_1 = \left(\begin{array}{c}12\\ 15 \end{array} \right), \vec{v}_2 = \left(\begin{array}{c}15\\ 5 \end{array} \right), Q_1 = 10\mu C, Q_2 = 20\mu C, \varepsilon =\varepsilon_0$
\end{enumerate}
\end{frame}
