...
\begin{frame}{Ladung eines Kondensators I}
  \begin{columns}
    ...
    \begin{tikzpicture}
      ...
      \draw (0,2) to[closing switch, l={t = 0}] (2,2) to [R=$R_C$] (4,2) to[C=$C$] (4,0)  -- (0,0);
    \end{tikzpicture}
...
\begin{frame}{Ladung eines Kondensators III}
  \begin{columns}
    ...
    \begin{tikzpicture}
      \draw (0,0) to[vsource, l=$U_{0}$] (0,2);
      \draw (0,2) to[normal closed switch, l={t > 0}] (2,2) to [R=$R_C$] (4,2) to[C=$C$] (4,0)  -- (0,0);
    \end{tikzpicture}
    \caption{Reihenschaltung von Widerstand und Kondensator}
  ...
  \end{figure}
    ...
    \begin{column}{0.5\textwidth}
      \begin{itemize}
        ...
        \item $u_c (t) = U_0+\Delta U \cdot e^{-\frac{t}{\tau}}$
      \end{itemize}
    \end{column}
  \end{columns}
\end{frame}
...
\begin{frame}{Ladung eines Kondensators IV}
  ...
  \begin{columns}
    \begin{column}{0.5\textwidth}
      ...
      $i_C(t) = \frac{U_0}{R_C}\cdot e^{-\frac{t}{\tau}} = I_0\cdot e^{\frac{t}{R_C\cdot C}}$
...
\begin{frame}{Ladung eines Kondensators V}
  \framesubtitle{Zeit bestimmen}
  \begin{align}
    u_c(t) = U_0 \cdot (1- e^{-\frac{t}{\tau}})\\
    t = ?\\
    \frac{u_c(t)}{U_0} = 1- e^{-\frac{t}{\tau}}\\
    1-\frac{u_c(t)}{U_0} = e^{-\frac{t}{\tau}}\\
     \text{ln}\left(1-\frac{u_c(t)}{U_0}\right) = -\frac{t}{\tau}\\
    - \tau \cdot \text{ln}\left(1-\frac{u_c(t)}{U_0}\right) = t
  \end{align}
$    \tau = R_C\cdot C$
\end{frame}
